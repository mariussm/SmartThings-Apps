...
metadata {
    ...
    preferences {
		...
		input name: "par47", type: "number", description: "Enter number", required: true,
        title: "Standard power reporting frequency. Default: 3600\n\n" +
        "Available settings: 0-65565 (s)"
...
def configure() {
	...
	delayBetween([   
		...
		zwave.configurationV1.configurationSet(parameterNumber: 47, size: 1, scaledConfigurationValue: par47.toInteger()).format(), 	// Parameter defines time period between reports sent when changes in power load have not been recorded. By default, if power load changes have not been recorded, reports are sent every hour. Default 3600
